...
const { checkDuplicateUsername, checkRolesExisted, checkMail } = require('../middleware/verifySignup');
...
router.post('/signup', checkMail , checkDuplicateUsername, checkRolesExisted ,authController.sigup);
